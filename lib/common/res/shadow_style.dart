...
class ShadowStyle {
  ...
  static black12Circle40() {
    return BoxDecoration(
        ...
        boxShadow: const [BoxShadow(offset: Offset(2, 1), color: Colors.black12, blurRadius: 12)]);
  }
  ...
  static white12Circle({double radius = 10}) {
    return BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(offset: const Offset(2, 1), color: ColorStyle.colorShadow, blurRadius: radius)
        ]);
  }
  ...
  static white12CircleBorder(
    ...
    return BoxDecoration(color: Colors.white, borderRadius: geometry, boxShadow: [
      BoxShadow(offset: const Offset(2, 1), color: ColorStyle.colorShadow, blurRadius: radius)
    ]);
  }
